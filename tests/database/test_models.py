...
def test_transfer_transaction(session):
    ...
    assert (
        queried_outgoing.transfer_transaction_id == incoming_transaction.transaction_id
    )
    ...
    assert (
        queried_incoming.transfer_transaction_id == outgoing_transaction.transaction_id
    )
